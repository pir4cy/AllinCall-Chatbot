...
var newConv = document.getElementById("newChat");
var midBox = document.querySelector('.midBox');
var lButton = document.querySelector('.launchButton');
...
function renderChatbox() {
  var string = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Hello, I'm Iris. A virtual assistance created to solve your queries.";
  midBox.innerHTML = '';
  ...
  messageBox.innerHTML = "<span class=\"appText\" style=\"top:12.5px; left:15px; font-weight: Medium;\">".concat(string, "</span>");
